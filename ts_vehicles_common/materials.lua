...
minetest.register_craftitem("ts_vehicles_common:lw_composite_material", {
    description = "Lightweight Composite Material for Vehicles",
    inventory_image = "ts_vehicles_common_lw_composite_material.png",
})

minetest.register_craft({
    output = "ts_vehicles_common:lw_composite_material",
    recipe = {
        { "techage:ta4_carbon_fiber", "techage:canister_epoxy", "default:mese_crystal" },
        { "techage:aluminum", "techage:vulcanized_rubber", "techage:aluminum" },
        { "default:gold_ingot", "techage:canister_epoxy", "techage:ta4_carbon_fiber" },
    },
    replacements = {
        { "techage:canister_epoxy", "techage:ta3_canister_empty" },
        { "techage:canister_epoxy", "techage:ta3_canister_empty" },
